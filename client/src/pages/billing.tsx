                ...
                <Card className="w-full max-w-4xl bg-card border-border">
                  <CardContent className="p-8">
                    <div className="mb-6 text-sm text-muted-foreground text-center">
                      Changes to these preferences will apply to future invoices only. If you need a past invoice reissued, please contact <a href="mailto:info@habarimedia.com" className="underline">info@habarimedia.com</a>.
                    </div>
